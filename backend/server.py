...
async def get_race_predictions(user: dict = Depends(auth_user)):
    ...
    return {
        ...
        "race_curve_diagnostics": {
            ...
            "k_identifiable": curve_diag.get("k_identifiable"),
            "k_identifiability_score": curve_diag.get("k_identifiability_score"),
            "k_identifiability_reason": curve_diag.get("k_identifiability_reason"),
